...
export default function MyAcc() {
	...
	const userAddressState = useMemo(() => userAddress, [userAddress]);
				...
				<div className={styles.blockInfo}>
					...
					<div className={styles.block}>
						<div className={styles.basicInfo}>
							...
							<Table
								data={userBasicInfo || {}}
								rows={userBasicInfo ? Object.keys(userBasicInfo) : []}
								flag={undefined}
							/>
						</div>
						<hr />
						<div className={styles.myAddress}>
							...
							<Table
								rows={Object.keys(userAddressConfig)}
								fieldsData={userAddressConfig}
								data={userAddress}
								flag={changeFlag}
							...
							{changeFlag ? (
								<div className={styles.blockForBtn}>
									<CustomBtn
										style={{ background: MAIN_COLOR_CORAL, margin: '10px' }}
										text={'Change'}
